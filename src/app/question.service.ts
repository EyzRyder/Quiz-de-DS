...
export class QuestionService {
  ...
  private questionsInfo: Question[] = [
    {
  ...
  nextQuestionEtim(): Question {
    if (this.questionCount < 5) {
      this.questionCount++;
      return this.questionsEtim[this.questionCount-1];
    } else {
      this.reset();
    }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsAdm[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsSj[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsDg[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsEv[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsHum[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsBio[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsInfo[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsDi[this.questionCount - 1];
  } else {
    this.reset();
  }
  ...
  if (this.questionCount < 5) {
    this.questionCount++;
    return this.questionsSec[this.questionCount - 1];
  } else {
    this.reset();
  }
